---
layout: default
title: Unpublished Work Archive
nav_order: 7
permalink: unpub_archive/
---

# Unpublished Work Archive
{: .no_toc}

<img src="\pages\07_UnpublishedWorkArchive\MRCsquirrel.jpeg" alt="Cover photo: MRC squirrel 2025"/>
...
| <img src="\pages\07_UnpublishedWorkArchive\cover_OTA2025.png" alt="cover_OTA2025" style="width:300px;"/> |([PDF](\pages\07_UnpublishedWorkArchive\OTA_Final_Presentation_Taran2025.pdf){: target="__blank"}) These presentation slides summarize the design of a two-stage operational transconductance amplifier that meets all the given stringent requirements in terms of voltage swing, gain, stability, rejection, and noise performance. The slides highlight key design steps, considerations, observations, and lessons from this individual final design project. Notably, the design successfully meets all requirements, which are rarely achieved in the class. |
